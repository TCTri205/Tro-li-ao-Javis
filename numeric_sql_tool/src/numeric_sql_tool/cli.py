...
def build_parser() -> argparse.ArgumentParser:
    ...
    load_data = sub.add_parser("load-data")
    ...
    numeric.add_argument("--user-id", default="00000000-0000-0000-0000-000000000000")
    ...
    batch.add_argument("--user-id", default="00000000-0000-0000-0000-000000000000")
